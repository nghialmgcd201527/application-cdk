...
class WAFAppStack(Stack):
    """Class to create WAF for Web App"""
    ...
    def __init__(self, scope: Construct, construct_id, **kwargs) -> None:
        ...
        bucket_name = f"{project_name}-web-app"
        ...
        web_acl = waf.CfnWebACL(
            ...
            name=project_name + "-" + stage + "web-app-acl",
        ...
        core.CfnOutput(
            ...
            export_name="waf-app-webacl-arn",
        )
