...
class WebIdentityStack(Stack):
    """Class to create Web Identity"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        bucket_name = f"{project_name}-web-identity-{environment}"
        web_domain = conf.get("web_domain")
        web_identity_domain = conf.get("web_identity_domain")
        ...
        my_hosted_zone = r53.HostedZone.from_lookup(
            self, f"{web_identity_domain}", domain_name=f"{web_domain}"
        )
        ...
        web_distribution = cloudfront.Distribution(
            ...
            domain_names=[web_identity_domain],
        ...
        r53.CfnRecordSetGroup(
            self,
            "web-identity-A-Record",
            record_sets=[
                r53.CfnRecordSetGroup.RecordSetProperty(
                    name=web_identity_domain,
                    type="A",
        ...
        core.CfnOutput(
            ...
            export_name=f"{project_name}-cfn-web-identity-url",
        )
        ...
        core.CfnOutput(
            ...
            export_name=f"{project_name}-cfn-web-identity-id",
        )
        ...
        core.CfnOutput(
            ...
            export_name=f"{project_name}-bucket-web-identity-arn",
        )
