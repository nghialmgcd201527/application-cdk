...
class WAFIdentityStack(Stack):
    """Class to create WAF for Web Identity"""
    ...
    def __init__(self, scope: Construct, construct_id, **kwargs) -> None:
        ...
        bucket_name = f"{project_name}-web-identity"
        ...
        web_acl = waf.CfnWebACL(
            ...
            name=project_name + "-" + stage + "web-identity-acl",
        ...
        core.CfnOutput(
            self,
            "waf-webacl-arn",
            value=self.waf_web_arn,
            export_name="waf-web-identity-acl-arn",
        )
